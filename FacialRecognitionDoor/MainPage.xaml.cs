...
namespace FacialRecognitionDoor
{
    public sealed partial class MainPage : Page
    {
        ...
        ///<summary>
        ///Entire code for speech recognition is given below
        ///</summary>
            ...
            this.IsEnabled = true;
                ...
                try
                {
                    ...
                    if (speechRecognitionResult.Status == SpeechRecognitionResultStatus.Success)
                    {
                        ...
                        {
                            resultTextBlock.Visibility = Visibility.Visible;
                            resultTextBlock.Text = "Not sure what you just said, please try again.";
                        }
                        else
                        {
                            string feedback = "";
                            ...
                            {
                                feedback = "You said " + speechRecognitionResult.Text;
                                Frame.Navigate(typeof(Sanya));
                                
                            }
                            else
                            {
                                feedback = "I think you said " + speechRecognitionResult.Text + ", right?";
                                Frame.Navigate(typeof(Sanya));
